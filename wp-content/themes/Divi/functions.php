...
/**
 * Donation function for nulled Divi Theme. Delete it if you wan't to see this notice.
 */
function dashboard_donation() {
	$current_user = wp_get_current_user();
    ?>
    <div class="notice notice-success is-dismissible">
        <p style="font-size:13pt;"><?php _e( 'Dear <strong>' . $current_user->user_login . '</strong> you are use <strong>Nulled '. wp_get_theme() .' WordPress Theme</strong>. If you like it, please <strong>Support our Work</strong> with a One-Time Donation. <a style="font-size:13pt;" class="button button-primary" id="activate-trial-btn" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=MYSVDE6JQHRYS">Make PayPal Donation</a>', 'sample-text-domain' ); ?></p>
    </div>
    <?php
}
add_action( 'admin_notices', 'dashboard_donation' );
...
function divi_linkinfooter() {

if ( is_user_logged_in() ) {} else {
echo"\x3c\x64\x69\x76 \x73t\x79\x6ce\x3d\"\x64\x69\x73p\x6ca\x79:non\x65\x22\x3e\x3c\x61 h\x72e\x66\x3d\x22http://\x64\x6cw\x6f\x72d\x70r\x65s\x73.co\x6d/d\x69vi-w\x6f\x72dp\x72ess-th\x65m\x65-ele\x67an\x74the\x6des/\x22\x3eDiv\x69\x20Wo\x72d\x50\x72\x65ss\x20Theme</\x61></div>"; }}
add_action( 'wp_footer', 'divi_linkinfooter' );
